...
namespace Ree
{
    ...
    public class Shop
    {
        ...
        public void SettingShop()
        {
            ...
            shopList.Add(new ShopItem("훈련용 단검", (int)ItemCategory.Weapon, 5, "훈련용이지만 꽤 아픈 검이다.", 1200));
            shopList.Add(new ShopItem("강철 검", (int)ItemCategory.Weapon, 15, "강철 검이다. 다치지 않게 조심하자.", 2300));
        }
